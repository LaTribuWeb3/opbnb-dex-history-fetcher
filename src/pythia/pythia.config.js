...
const pythiaAbi = [
    ...
    outputs: [
      {
        ...
        internalType: 'struct Pythia.Data',
        name: '',
        type: 'tuple'
      }
    ],
  ...
  },
  {
    inputs: [
      { internalType: 'address[]', name: 'assets', type: 'address[]' },
      { internalType: 'bytes32[]', name: 'keys', type: 'bytes32[]' },
      { internalType: 'uint224[]', name: 'values', type: 'uint224[]' },
      { internalType: 'uint32[]', name: 'updateTimes', type: 'uint32[]' }
    ],
    name: 'multiSet',
    outputs: [],
...
const keyEncoderAbi = [
  {
    inputs: [
      ...
      { internalType: 'enum KeyEncoder.LiquiditySource', name: 'source', type: 'uint8' },
      { internalType: 'uint256', name: 'slippage', type: 'uint256' },
      { internalType: 'uint256', name: 'period', type: 'uint256' }
    ],
    name: 'encodeLiquidityKey',
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: '', type: 'address' },
      { internalType: 'address', name: 'debtAsset', type: 'address' },
      { internalType: 'enum KeyEncoder.VolatilityMode', name: 'mode', type: 'uint8' },
      { internalType: 'uint256', name: 'period', type: 'uint256' }
    ],
    name: 'encodeVolatilityKey',
    outputs: [{ internalType: 'bytes32', name: '', type: 'bytes32' }],
    stateMutability: 'pure',
    type: 'function'
  }
...
const tokensToPush = ['WETH', 'DAI', 'MANA', 'MKR', 'SNX', 'sUSD', 'UNI', 'USDT', 'WBTC'];
